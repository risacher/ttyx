/**
 * ttyx.js
 * Copyright (C) 2016-2025 Dan Risacher, https://risacher.org/
 * 
...
Server.prototype.initMiddleware = function() {
    ...
    console.log(__dirname + '/../node_modules/@xterm');
    this.use('/xterm', express.static(__dirname + '/../node_modules/@xterm'));
...
Session.prototype.handleCreate = function(cols, rows, cb) {
  var self = this
    , terms = this.terms
